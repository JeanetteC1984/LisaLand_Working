...
- **Calendar**: Daily/Weekly/Monthly views with navigation, time blocking (6AM–11PM hourly slots), drag-and-drop events, event form with full customization. Events persist in localStorage. Weekly & daily views are **color-blocked by time period**: dawn (6–8 AM, purple), morning (9–11 AM, orange), midday (12–1 PM, pink), afternoon (2–4 PM, cyan), evening (5–7 PM, magenta), night (8–11 PM, deep violet). Time gutter labels also color-coded. Light theme variants included.
